...
pub struct Resolver<'ra, 'tcx> {
    ...
    /// Attribute invocations that resolved to `Res::NonMacroAttr` and returned their input unchanged.
    non_macro_attr_expansions: FxHashSet<LocalExpnId> = default::fx_hash_set(),
