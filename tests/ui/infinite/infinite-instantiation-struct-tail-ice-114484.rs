...
//~| ERROR reached the recursion limit finding the struct tail for `[u8; 256]`
//~| ERROR reached the recursion limit finding the struct tail for `[u8; 256]`
//~| ERROR reached the recursion limit finding the struct tail for `SomeData<const { 256 }>`
//~| ERROR reached the recursion limit finding the struct tail for `SomeData<const { 256 }>`
//~| ERROR reached the recursion limit finding the struct tail for `SomeData<const { 256 }>`
//~| ERROR reached the recursion limit finding the struct tail for `SomeData<const { 256 }>`
//~| ERROR reached the recursion limit finding the struct tail for `VirtualWrapper<SomeData<const { 256 }>, const { 0 }>`
//~| ERROR reached the recursion limit finding the struct tail for `VirtualWrapper<SomeData<const { 256 }>, const { 0 }>`
//~| ERROR reached the recursion limit finding the struct tail for `VirtualWrapper<SomeData<const { 256 }>, const { 0 }>`
//~| ERROR reached the recursion limit finding the struct tail for `VirtualWrapper<SomeData<const { 256 }>, const { 0 }>`
//~| ERROR reached the recursion limit while instantiating `<VirtualWrapper<..., const { 1 }> as MyTrait>::virtualize`
